    ...
    <div className="flex flex-col p-8 h-full bg-black justify-between">
      <div>
        ...
        <nav className="flex flex-col space-y-6">
          ...
          <Link href="/admin/configuracion" className="text-xs tracking-widest uppercase text-zinc-500 hover:text-cyan-400 hover:translate-x-1 transition-all">CONFIGURACION</Link>
        </nav>
      </div>
