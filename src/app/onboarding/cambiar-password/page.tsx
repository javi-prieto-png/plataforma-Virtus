    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 selection:bg-cyan-500 selection:text-black">
      <div className="max-w-xl w-full border border-zinc-900 bg-zinc-950 p-10 relative overflow-hidden group">
        <h1 className="text-2xl tracking-widest text-white mb-2 uppercase font-light">
          Protocolo de <span className="text-cyan-400 font-bold text-shadow-neon">Seguridad</span>
        </h1>
        <p className="text-zinc-500 text-xs tracking-widest uppercase mb-10">
          [ACCESO RESTRINGIDO] Requiere actualización de credenciales.
        </p>
        ...
        <form action={handleAction} className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <label className="text-xs text-zinc-400 uppercase tracking-widest font-bold">Nueva Contraseña</label>
            <input
              type="password"
              name="newPassword"
              required
          ...
          <div className="flex flex-col gap-2">
            <label className="text-xs text-zinc-400 uppercase tracking-widest font-bold">Confirmar Contraseña</label>
            <input
              type="password"
          ...
          >
            {isPending ? "ENCRIPTANDO..." : "ACTUALIZAR CREDENCIALES"}
          </button>
        </form>
      </div>
    </div>
