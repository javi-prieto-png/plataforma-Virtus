    ...
    <div className="flex flex-col p-8 h-full bg-black">
      ...
      <nav className="flex flex-col space-y-8 flex-grow">
        <div className="flex flex-col space-y-4">
          ...
          <Link href="/dashboard/chat/inbox" className="text-xs tracking-widest uppercase text-zinc-400 hover:text-cyan-400 hover:translate-x-1 transition-all">❯ Buzon (ChAT)</Link>
        </div>
